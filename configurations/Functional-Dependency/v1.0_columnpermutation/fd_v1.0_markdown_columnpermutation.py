...
dataset_config = {
    ...
    "version": "1.0_sample1000_markdown_columnpermutation",
    "tag": ["1.0_sample1000_markdown_columnpermutation"],
    ...
    "fields": {
        "input_table": {
            ...
            "processors": [ShuffleRowsProcessor(), FirstNRowsProcessor(50), ShuffleColumnsKeepFirstThreeProcessor()],
        }
    }
}
