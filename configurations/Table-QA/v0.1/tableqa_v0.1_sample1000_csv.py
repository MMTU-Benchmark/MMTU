...
4. Format the Answer: Finally, return the answer in a structured JSON format: {"answer": <answer>}. If the question cannot be answered due to missing or ambiguous data, return a JSON response with {"answer": null}.
