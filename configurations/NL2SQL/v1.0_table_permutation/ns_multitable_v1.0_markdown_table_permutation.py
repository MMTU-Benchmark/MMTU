...
dataset_config = {
    "task": "NL2SQL",
    "version": "1.0_sample1000_markdown_multitable_table_permutation",
        ...
        "tables": {
            ...
            "fields": {
                ...
                "data": {
                    ...
                    "processors": [FirstNRowsProcessor(n=10), ShuffleColumnsKeepFirstThreeProcessor(), ShuffleRowsProcessor()],
                    "name": "data"
                }
            }
        },
