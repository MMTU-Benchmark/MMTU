...
5. Do not explain the formula — just output the formula itself in a JSON format: {"formula": "your_formula_here"}.
...
dataset_config = {
    ...
    "path": "/datadrive/junjie/TableBenchmarkSurvey/data/Formula-prediction-context/sample1000",
    "info": "info.json",
    "fields": {
        "input_table": {
            "type": "table.csv",
