...
dataset_config = {
    "task": "NL2SQL",
    "version": "0.1_sample1000_markdown_multitable",
    "tag": "0.1_sample1000_markdown_gpt35",
    "note": "NL2SQL datasets multi-table. Sample 1000 test cases for each dataset.",
    "path": "/datadrive/junjie/TableBenchmarkSurvey/data/NL2SQL/benchmark/sample1000/multitable",
    "info": "info.json",
    "fields": {
        "db_id": {
            "type": "text",
        ...
        "tables": {
            ...
            "fields": {
                ...
                "data": {
                    ...
                    "reader": "pandas",
                    "serializer": MarkdownSerializer,
                    "processors": [FirstNRowsProcessor(n=50)],
                    "name": "data"
                }
            }
        },
