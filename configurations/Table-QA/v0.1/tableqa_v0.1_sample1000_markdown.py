...
4. Format the Answer: Finally, return the answer in a structured JSON format, for example: {"answer": <answer>}. If the question cannot be answered due to missing or ambiguous data, return a JSON response with {"answer": null}.
...
dataset_config = {
    ...
    "path": "/datadrive/junjie/TableBenchmarkSurvey/data/Table-QA/benchmark/sample1000",
    "info": "info.json",
    "fields": {
        "table": {
            "type": "table.csv",
