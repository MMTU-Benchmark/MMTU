...
dataset_config = {
    ...
    "tag": ["0.1_sample1000_html"],
    # "note": "NL2SQL datasets multi-table. Sample 1000 test cases for each dataset.",
    "path": "/datadrive/junjie/TableBenchmarkSurvey/data/Data-transform-reshape/sample1000",
    "info": "info.json",
    "fields": {
        "input_table": {
            "type": "table.csv",
